...
class Hotel(BaseModel):
    ...
    politicas_pago = db.relationship("PoliticaDePago", back_populates="hotel", cascade="all, delete-orphan")
    politicas_cancelacion = db.relationship("PoliticaDeCancelacion", back_populates="hotel", cascade="all, delete-orphan")
